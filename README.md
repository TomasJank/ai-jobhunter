...
- **Scrapes real jobs from free sources** — hidden career-site JSON APIs (Amazon, Workday tenants, SmartRecruiters, Oracle Cloud — JP Morgan / Honeywell, IBM), ATS boards (Greenhouse / Lever / Ashby), Radancy sites (Intuit, Barclays), RSS feeds (WeWorkRemotely), Algolia (Hacker News "Who is hiring"), and Eightfold boards (Netflix). Zero paid infrastructure. Apple, Google, Microsoft, and Qualcomm are supported too but experimental — they need headless Chrome and can time out.
